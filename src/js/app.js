...
function iniciarApp() {
    ...
    seleccionarFecha();//añade la fehca al objeto de cita
    seleccionarHora();
    mostrarResumen(); // muestra al resumen de la cita
...
async function consultarAPI() {
    try {
        const url = 'https://agile-atoll-96394.herokuapp.com/api/servicios';
...
function mostrarServicios(servicios) {
    servicios.forEach(servicio => {
        ...
        nombreSrevicio.textContent = nombre;
        ...
        servicioDiv.appendChild(nombreSrevicio);
